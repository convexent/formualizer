...
pub struct S070VlookupCacheKMuchLessThanN {
    scale: ScaleState,
}
impl Default for S070VlookupCacheKMuchLessThanN {
    fn default() -> Self {
        Self::new()
    }
}
impl S070VlookupCacheKMuchLessThanN {
    pub fn new() -> Self {
        Self {
...
impl Scenario for S070VlookupCacheKMuchLessThanN {
    fn id(&self) -> &'static str {
        "s070-vlookup-cache-K-much-less-than-N"
    }
    fn description(&self) -> &'static str {
        "Repeated VLOOKUP exact-match formulas reuse a cache over a 10k-row table with K much less than N."
    }
