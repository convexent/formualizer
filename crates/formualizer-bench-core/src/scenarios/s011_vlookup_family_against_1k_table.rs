...
pub struct S011VlookupFamilyAgainst1kTable {
    scale: ScaleState,
}

impl Default for S011VlookupFamilyAgainst1kTable {
    fn default() -> Self {
        Self::new()
    }
}

impl S011VlookupFamilyAgainst1kTable {
    pub fn new() -> Self {
        Self {
...
impl Scenario for S011VlookupFamilyAgainst1kTable {
    fn id(&self) -> &'static str {
        "s011-vlookup-family-against-1k-table"
    }

    fn description(&self) -> &'static str {
        "VLOOKUP formula family against a shared 1k-row lookup table."
    }
