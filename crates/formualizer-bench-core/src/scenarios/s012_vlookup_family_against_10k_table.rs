...
pub struct S012VlookupFamilyAgainst10kTable {
    scale: ScaleState,
}

impl Default for S012VlookupFamilyAgainst10kTable {
    fn default() -> Self {
        Self::new()
    }
}

impl S012VlookupFamilyAgainst10kTable {
    pub fn new() -> Self {
        Self {
...
impl Scenario for S012VlookupFamilyAgainst10kTable {
    fn id(&self) -> &'static str {
        "s012-vlookup-family-against-10k-table"
    }

    fn description(&self) -> &'static str {
        "VLOOKUP formula family against a shared 10k-row lookup table."
    }
