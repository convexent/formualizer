...
pub struct S073MatchThenIndexCache {
    scale: ScaleState,
}
impl Default for S073MatchThenIndexCache {
    fn default() -> Self {
        Self::new()
    }
}
impl S073MatchThenIndexCache {
    pub fn new() -> Self {
        Self {
...
impl Scenario for S073MatchThenIndexCache {
    fn id(&self) -> &'static str {
        "s073-match-then-index-cache"
    }
    fn description(&self) -> &'static str {
        "INDEX/MATCH exact-match formulas reuse the MATCH lookup cache."
    }
    ...
    fn build_fixture(&self, ctx: &ScenarioBuildCtx) -> Result<ScenarioFixture> {
        ...
        write_workbook(&path, |book| {
            ...
            for r in 1..=rows {
                ...
                sheet.get_cell_mut((2,r)).set_formula(format!("=INDEX(Lookup!$B$1:$B${LOOKUP_ROWS}, MATCH(A{r}, Lookup!$A$1:$A${LOOKUP_ROWS}, 0))"));
            }
        });
        Ok(ScenarioFixture {
            path,
