...
pub struct S081AffineRowLiterals {
    scale: ScaleState,
}

impl Default for S081AffineRowLiterals {
    fn default() -> Self {
        Self::new()
    }
}

impl S081AffineRowLiterals {
    pub fn new() -> Self {
        Self {
...
impl Scenario for S081AffineRowLiterals {
    fn id(&self) -> &'static str {
        "s081-affine-row-literals"
    }

    fn description(&self) -> &'static str {
        "Row-wise affine literal family =A$1*{row}; should encode literals as AffineByRow."
    }
